...
/**
 * Processes Arabic text for PDFKit.
 ...
 * @returns {string} - The processed text ready for pdfkit.
 */
export function processArabic(text) {
    ...
    try {
        ...
        // IMPORTANT: We get embedding levels from the ORIGINAL logical text
        // because bidi-js handles logical Arabic characters better than reshaped ones.

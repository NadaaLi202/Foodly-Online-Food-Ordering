...
const PLACEHOLDERS = [
    ...
    { label: 'الرقم الضريبي', tag: '{{company.vat}}' },
    { label: 'السجل التجاري', tag: '{{company.commercial_register}}' },
    { label: 'المدينة', tag: '{{company.city}}' },
    { label: 'الشعار', tag: '{{company.logo}}' },
    ...
    { label: 'رقم الفاتورة', tag: '{{invoice.name}}' },
    { label: 'تاريخ الفاتورة', tag: '{{invoice.invoice_date}}' },
    { label: 'اسم العميل', tag: '{{invoice.partner.name}}' },
    { label: 'عنوان العميل', tag: '{{invoice.partner.street}}' },
    { label: 'الرقم الضريبي للعميل', tag: '{{invoice.partner.vat}}' },
    { label: 'بنود الفاتورة', tag: '{{invoice.invoice_line_ids}}' },
    { label: 'الإجمالي قبل الضريبة', tag: '{{invoice.amount_untaxed}}' },
    { label: 'قيمة الضريبة', tag: '{{invoice.amount_tax}}' },
    { label: 'الإجمالي بعد الضريبة', tag: '{{invoice.amount_total}}' },
    { label: 'رمز QR', tag: '{{invoice.qr_code}}' },
    { label: 'الحسابات البنكية', tag: '{{invoice.company_id.account_ids}}' },
    { label: 'اسم العميل (قديم)', tag: '{{partner.name}}' },
    { label: 'عنوان العميل (قديم)', tag: '{{partner.address}}' },
    { label: 'الرقم الضريبي للعميل (قديم)', tag: '{{partner.tax_number}}' },

...
const ProductLabelAdd = () => {
    ...
    const handleSave = async () => {
        ...
        } catch { toast.error('فشل إنشاء الملصق'); }
            ...
            <div className="flex-1 flex flex-col">
                <div className="bg-white mx-4 mb-4 rounded-lg border border-gray-200 shadow-sm flex flex-col">
                    ...
                    <div className="flex items-center gap-3 px-6 py-4 border-t border-gray-200 bg-white rounded-b-lg">
                        <Link to="/dashboard/templates/product-labels" className="px-6 py-2.5 border border-gray-200 rounded-lg text-sm font-bold text-gray-600 hover:bg-gray-50 transition-colors">إلغاء</Link>

    ...
    return (
        <div className="p-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div className="hidden print:block mb-16">
                    <PrintHeader title={t('reports.accounting.tax.summary_report_title') || 'Summary Tax Report'} isRTL={true} showLogo={false} />
                </div>
                {/* Filters Section */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4 print:hidden">
                    {/* Period */}
                    <div>
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 mb-4 p-4 bg-gray-50 rounded-lg border border-gray-100 print:hidden">
                ...
                {/* Table */}
                <div className="border border-gray-200 rounded-lg overflow-hidden mt-4 print:mt-32">

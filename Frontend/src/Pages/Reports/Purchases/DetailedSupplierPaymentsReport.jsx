...
const DetailedSupplierPaymentsReport = () => {
    ...
    const availableColumns = [
        { key: 'supplier_payment', label: t('reports.columns.supplier_payment') || 'Supplier Payment' },
        { key: 'type', label: t('reports.columns.type') || 'Type' },
        { key: 'date', label: t('reports.columns.date') || 'Date' },
        { key: 'supplier', label: t('reports.columns.supplier') || 'Supplier' },
        { key: 'invoices', label: t('reports.columns.invoices') || 'Invoices' },
        { key: 'branch', label: t('reports.columns.branch') || 'Branch' },
        { key: 'treasury', label: t('reports.columns.treasury') || 'Treasury' },
        { key: 'processed_amount', label: t('reports.columns.processed_amount') || 'Processed Amount' },
    ];

    // Default selected columns based on Image 2
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 mb-4 p-4 bg-gray-50 rounded-lg">
                    <div className="text-sm text-gray-700">
                        <span className="font-medium">{t('detailed_supplier_payments_report_title') || 'Detailed Supplier Payments Report'}</span>

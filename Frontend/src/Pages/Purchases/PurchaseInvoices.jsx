...
const PurchaseInvoices = () => {
    ...
    const handleCloseModal = () => {
        ...
        // Assuming current path is .../invoices/add, we want .../invoices
        const newPath = location.pathname.replace(/\/add$/, '');
        navigate(newPath);
    };
            ...
            <div className="mt-5">
                ...
                >
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">
                        {t('purchases_page.no_invoices')}
                    </h3>
                    <p className="mt-1 text-sm text-gray-500">
                        {t('purchases_page.start_invoices')}
                    </p>
                </button>
            </div>
